...
function timeElapse(e) {
   var date2 = new Date();    //结束时间  
    var date3 = date2.getTime() - new Date(e).getTime();   //时间差的毫秒数        
    ...
    var o = '    <span class="digit">' + days + '</span> 天 <span class="digit">' + hours + '</span> 时 <span class="digit"><br/>  ' + minutes + '</span> 分 <span class="digit">' + seconds + "</span> 秒";
    $("#elapseClock").html(o)
}
function timeElapse1(e) {
   var date2 = new Date();    //结束时间  
    var date3 = date2.getTime() - new Date(e).getTime();   //时间差的毫秒数        
